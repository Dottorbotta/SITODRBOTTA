  ...
  return (
    <><Header tone="dark" /><main id="contenuto" tabIndex={-1}>
      <section className="blog-hero">
        ...
        <div className="blog-hero-side"><p>Parti dall’argomento che ti riguarda. Ogni approfondimento collega informazioni, fonti e scelte sul movimento.</p><a className="text-link" href="/blog/argomenti/piede">Articoli su piede e caviglia →</a></div>
      </section>
      <TopicLinks />
